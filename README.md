...
- A Google Gemini API key and a Google Fact Checking API key is needed.
  - Create two API keys from [Google Console](https://console.cloud.google.com/apis/dashboard).
